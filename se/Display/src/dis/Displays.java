...
public class Displays extends Application  {
    ...
    private static final int WIDTH = 1300; // 7
    private static final int HEIGHT = 800; // 10
    ...
    public void start(Stage stage) throws Exception {
        ...
        // SCENE 1 //
        // Creating an image
        Image image1 = new Image(new FileInputStream("C:\\Users\\Admin\\Desktop\\se\\Display\\src\\image.png"));
        ...
        Scene scene2 = new Scene(layout2, WIDTH, HEIGHT, Color.WHITESMOKE);
        VBox box = new VBox();
        ...
        // IMAGE
        Image imageCluster = new Image(new FileInputStream("C:\\Users\\Admin\\Desktop\\se\\Display\\src\\cluster.png"));
        // BUTTON
