...
public class DataSet {
    ...
    public final static LinkedList<String> attrNames = new LinkedList<>();
    public final static LinkedList<Record> records = new LinkedList<>();
    ...
    public void StoreOutput(){
            ...
            for(var record : records){
                ...
                System.out.print(record.clusterNo);
                System.out.print("\n");
            }
    }
